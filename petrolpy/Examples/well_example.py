...
print(well)
#%%
data = pd.read_csv("https://raw.githubusercontent.com/mwentzWW/petrolpy/master/petrolpy/Test_Data/test_data_DRI%20Producing%20Entity%20Monthly%20Production.CSV")
#%%
